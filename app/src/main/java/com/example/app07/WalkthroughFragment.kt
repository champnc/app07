...
import com.example.app07.walkthrough.ViewAdapter
...
class WalkthroughFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val walkthroughList = listOf<ViewItem>(
            ViewItem("The only thing we’re serious about is food.", R.drawable.onboarding1,"Fresh Food"),
            ViewItem("Faster than you can imagine. Tracking and courier delivery services", R.drawable.onboarding2,"Fast Delivery"),
            ViewItem("It's a faster, simpler and smarter way to paid your food.", R.drawable.onboarding3,"Easy Payment")
        )
        ...
        goBtn.setOnClickListener{
            findNavController()?.navigate(R.id.action_walkthroughFragment_to_catalogFragment)
        }
